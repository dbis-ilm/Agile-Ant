...
private[spark] object BlockManagerMessages {
  ...
  // Agile-Ant: Start
  case class SendAMessageToExecutorCacheManagers(messageType: MessageType, messageContent: Any, executorIds: Set[Int] = Set()) 

  case class ReceiveAMessageFromTheClusterCacheManager(messageType: MessageType, messageContent: Any) 
  // Agile-Ant: End
  ...
  case class ReceiveAMessageFromAnExecutorCacheManager(messageType: MessageType, executorId: Int, messageContent: Any) extends ToBlockManagerMaster // Agile-Ant
