...
class BlockManagerStorageEndpoint(
  ...
  override def receiveAndReply(context: RpcCallContext): PartialFunction[Any, Unit] = {
    ...
    case ReceiveAMessageFromTheClusterCacheManager(messageType, messageContent)=> // Agile-Ant
      blockManager.executorCacheManager.ReceiveAMessageFromTheClusterCacheManager(messageType, messageContent)
      context.reply(true)
